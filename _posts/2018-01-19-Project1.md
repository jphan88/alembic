...
---
{% include figure.html image="/assets/Screen Shot 2018-02-03 at 5.40.21 PM.png" caption="Original Data" position="center" %}
---
...
{% include figure.html image="/assets/foot traffic bubbles.png" caption="Original Data" position="center" %}
...
{% include figure.html image="/assets/foot traffic.png" caption="Original Data" position="center" %}
...
{% include figure.html image="/assets/overlap.png" caption="Original Data" position="center" %}
...
{% include figure.html image="/assets/station.png" caption="Original Data" position="center" %}
